...
describe AnimalesController do
  ...
  # AnimalesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET index" do
    it "assigns all animales as @animales" do
      ...
      assigns(:animales).should eq([animal])
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved animal as @animal" do
        ...
        post :create, {:animal => { "nombre" => "invalid value" }}, valid_session
        assigns(:animal).should be_a_new(Animal)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested animal" do
        animal = Animal.create! valid_attributes
        # Assuming there are no other animales in the database, this
        # specifies that the Animal created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Animal.any_instance.should_receive(:update_attributes).with({ "nombre" => "MyString" })
        put :update, {:id => animal.to_param, :animal => { "nombre" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the animal as @animal" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Animal.any_instance.stub(:save).and_return(false)
        put :update, {:id => animal.to_param, :animal => { "nombre" => "invalid value" }}, valid_session
        assigns(:animal).should eq(animal)
      end
