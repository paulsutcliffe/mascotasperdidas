  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved plan as @plan" do
        ...
        post :create, {:plan => { "dias" => "invalid value" }}, valid_session
        assigns(:plan).should be_a_new(Plan)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested plan" do
        plan = Plan.create! valid_attributes
        # Assuming there are no other planes in the database, this
        # specifies that the Plan created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Plan.any_instance.should_receive(:update_attributes).with({ "dias" => "1" })
        put :update, {:id => plan.to_param, :plan => { "dias" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the plan as @plan" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Plan.any_instance.stub(:save).and_return(false)
        put :update, {:id => plan.to_param, :plan => { "dias" => "invalid value" }}, valid_session
        assigns(:plan).should eq(plan)
      end
